...
func New(svc pb.DemoServer) (ws *warden.Server, err error) {
	...
	//opts:=[]grpc.ServerOption{grpc_middleware.WithUnaryServerChain(
	//	jaegerGrpcServerInterceptor,
	//	),
	//}
	//test := grpc.UnaryInterceptor(grpc_middleware.ChainUnaryServer(
	//	jaegerGrpcServerInterceptor,
	//),
	//)
